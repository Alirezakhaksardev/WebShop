...
import { Box , Flex , HStack , Link , IconButton , Icon , Text , useDisclosure , Button , Stack , useColorModeValue , useColorMode, Center } from '@chakra-ui/react'
...
function Navbar() {
    ...
    const links = [
        {linkName : "Producets" , path : "/products" },
        ...
        <>
            <Box bg={useColorModeValue('gray.100' , 'gray.900')} px={4}>
                <Flex h={16} alignItems='center' justifyContent='space-between'>
                    <IconButton size='md' icon={isOpen ? <CloseIcon/> : <HamburgerIcon/>} display={{md:'none'}}
                    ...
                    <Flex alignItems='center'  onClick={() => toggleColorMode()}>
                        ...
                        <Button as={ReactLink} to={'/registration'} m={2} fontSize='sm' fontWeight={600} 
                            _hover={{bg:'orange.400'}} bg='orange.500' color={'white'} display={{md : 'inline-flex' , base:'none'}}>Sign Up</Button>
                    </Flex>
