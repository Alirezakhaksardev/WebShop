...
function ProductCard({product}) {
  return (
    <Stack p={2} spacing={'3px'} bg={useColorModeValue('white' , 'gray.800')} minW='250px' h='450px' border={'1px'} rounded='lg' shadow='lg' position='relative' >
        ...
        <Box flex='1' maxH={5} alignContent={'baseline'}>
            {product.stock <= 0 && (
